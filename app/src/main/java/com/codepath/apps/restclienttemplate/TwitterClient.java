...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "3RqVrvlFqv4eBN4JgAEW80tXZ";       // Changed
	public static final String REST_CONSUMER_SECRET = "KKBWyWlSonWbN122EIem2XGo5BkUuUXYKvXmua1Axqr6IrWN5N"; // Changed
	...
	public void reTweet(long ret, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/retweet/" + ret + ".json");
		RequestParams params = new RequestParams();
		params.put("id", ret);
		client.post(apiUrl, params, handler);
	}
